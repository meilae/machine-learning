...
%load('savedTrainingData.mat');

%%
% Training 
fprintf('Training ... ');
VLFEAT_FOLDER = 'vlfeatroot'; %Put here the path to the root floder of VlFeat
addpath([VLFEAT_FOLDER  '/toolbox']);
vl_setup;

tic;
% Put here the SVM training code here
[w,b] = vl_svmtrain(DataTrain',LabelsTrain', 1000);
toc;
%keyboard
%%
% Test Svm.
...
falsePosRate = cumsum( ~positives ) / sum( ~positives );
figure;
